                ...
                ref.putFile(imgUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                       ...
                       //String placeInfo = EdtPlaceInfor.getText().toString().trim();
                        ...
                        //matching the contsr.
                        ImageUpload imageUpload = new ImageUpload(placeName,EdtPlaceInfor.getText().toString(),placeAddress,placeCell,placeHours,placeWebsite,placeLongitude,placeLatitude,urI);
